  ...
  return (
    <div className="text-center bg-gray-100 p-4 rounded-lg hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-105">
        ...
        src={image}
         ...
         <p className="mt-[1rem] text-black opacity-90 text-[15px] ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis aperiam quod reiciendis illo corporis eligendi veniam quaerat quibusdam!</p>
