  ...
  return (
    <div className="pt-[3rem] pb-[3rem]">
        <div className="w-[80%] mx-auto grid grid-cols-1 border-b-[1.5px] border-b-slate-300 pb-[2rem] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[2rem] items-start">
            ...
            <div className="md:mx-auto mx-0">
                <h1 className="text-[17px] text-gray-900 font-semibold mb-[1.5rem]">My Accounts</h1>
                ...
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">Images & B-roll</p>
            ...
            <div className="md:mx-auto mx-0">
                ...
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">Returns Policy</p>
                ...
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">Store Hours</p>
            </div>
            <div className="md:mx-auto mx-0">
                ...
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">About Us</p>
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">Copyright</p>
                <p className="text-black opacity-80 mb-[1rem] text-[15px] cursor-pointer hover:text-yellow-600">Popular Compaign</p>
            </div>
        </div>
        <div className="w-[80%] mx-auto mt-[1rem] text-[15px] opacity-70">Copyright &#169; by 2024 webdev warriros</div>
        </div>
  )
}
